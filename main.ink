...
+ [Да]
Тут он в точку уменьшился, комаром оборотился, полетел и запищал, судно на море догнал, потихоньку опустился на корабль — и в щель забился.  -> lebed3
+ [Нет]
...
+ [В правый]
Повариха побледнела, обмерла и окривела.  ~ score = score + 10
-> lebed4
+ [В левый]
...
Превратиться в муху?
+ [Да]
 В муху князь оборотился, полетел и опустился между моря и небес на корабль — и в щель залез. -> lebed6
+ [Нет]
...
-> lebed7
+ [В левый]
  И ткачиха побледнела - «Ай!» и тут же окривела;  ~ score = score + 10  #З
...
+ [Да]
 Тут он очень уменьшился, Шмелем князь оборотился, Полетел и зажужжал; Судно на море догнал, Потихоньку опустился на корму — и в щель забился.  ~ score = score + 10-> lebed9
+ [Нет]
...
Укусить Бабариху?
+ [В нос]
 Нос ужалил богатырь. На носу вскочил волдырь. ~ score = score + 10 -> lebed10
+ [Не кусать]
...
* {has_10 and has_11 and has_12} [Все чудеса хочу увидеть сам]
    Салтан: Снарядить флот! ~ score = score + 10
-> lebed12
= lebed12
#Location: dvores
